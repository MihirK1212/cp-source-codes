...
void unionDSU(vll&parent,ll x,ll y)
{
    ...
    parent[y_rep] = x_rep; //we add the subtree with y_rep as root as a child of x_rep
                           //hence the root of x and y are now the same 
}
